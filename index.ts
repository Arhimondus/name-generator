...
function fixName(baseName: string) {
...
class GeneratedName {
	public static defaultFormat = '%1f %1i. %1o.';

	constructor(public imya: string, public familiya: string, public otchestvo: string) {}
...
export function setDefaultFormat(template: string) {
	GeneratedName.defaultFormat = template;
}

export function generateFromDefined(gender: 'male' | 'female', imya: string, familiya: string, otchestvo: string) {
...
*/
export default function generate(gender: 'male' | 'female' = chance.pickone(['male', 'female'])) {
